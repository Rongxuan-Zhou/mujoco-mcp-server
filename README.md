...
MuJoCo physics simulation as **52 MCP tools** for [Claude Code](https://claude.ai/code) and other [Model Context Protocol](https://modelcontextprotocol.io) clients — run simulations, render frames, analyze physics, control robots, and sweep parameters directly from your AI assistant.
